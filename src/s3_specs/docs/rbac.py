...
key_pairs = [
    ("86bcbdce-2be6-49c7-9105-c18fba30c493", "37d64892-54bc-4a3c-9062-f93effc851e1"), # no permissions
    ("5d133346-d63e-4c51-a296-6125a221e33d", "76326b89-722a-4e21-b61b-9ca13df5247d"), # READ permissions
    ("adbd7826-af9a-445b-803c-8a849a7d4c4b", "db805181-69bb-4fc2-b775-b9c43ce9d623"), # WRITE permissions
]
clients = [
    boto3.Session(
            region_name="br-ne1",
...
test_cases = [
    # {'client': client, 'action': action, 'positive_result': j>i}
    (client, action, j>i)
